...
import (
	...
	"github.com/liquid-reply/gardener-extension-shoot-kepler/pkg/apis/config/v1alpha1"
...
// NewServiceControllerCommand creates a new command that is used to start the shoot-kepler controller
func NewServiceControllerCommand() *cobra.Command {
	options := NewOptions()

	cmd := &cobra.Command{
		Use:           "gardener-extension-shoot-kepler",
